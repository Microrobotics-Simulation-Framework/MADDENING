...
| MADD-ANO-032 | After a parameter write and compile(), ShardedStencilNode and ShardedUnstructuredNode kept stepping with the old value of a constant their node reads from self.params | `major` | `context_dependent` | `resolved` (in 0.4.0) | >=0.2.0, <0.4.0 |
