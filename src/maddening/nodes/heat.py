...
class HeatNode(SimulationNode):
    ...
    meta = NodeMeta(
        ...
        hazard_hints=(
            ...
            "Two rods exchanging end-cell temperatures in a converged coupling group diverge above Fourier number 3/8, which each rod's own constructor check (limit 1/2) accepts; the growth alternates sign every step and leaves float range in under 70 steps at Fo = 0.45 (MADD-ANO-049)",
        ),
        implementation_map={
