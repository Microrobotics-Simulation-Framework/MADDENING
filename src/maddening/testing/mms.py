...
#: three logs, which are in the tree and regenerated by the scripts
...
#: 3.957, and an edge fitted to them false-fires on ``exp_sin``
#: (3.999) and ``tanh_bump`` (4.001-4.126), neither of which is doing
#: anything wrong.
#:
...
#: 2.000-2.003 and is rejected by the *shortfall*, an order and a half
#: clear of the band edge.  This constant is a coarse sanity check on
