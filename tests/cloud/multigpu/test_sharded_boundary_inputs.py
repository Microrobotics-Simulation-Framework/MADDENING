...
# Per push, one check of the battery on the same wrapper:
# tests/cloud/multigpu/test_verify_node_check_on_a_sharded_wrapper.py::test_a_verify_node_check_passes_on_the_sharded_wrapper
